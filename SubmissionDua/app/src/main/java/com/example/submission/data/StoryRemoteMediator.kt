...
import com.example.submission.database.RemoteKeys
import com.example.submission.database.StoryResponseDatabase

@OptIn(ExperimentalPagingApi::class)
class StoryRemoteMediator(
    private val database: StoryResponseDatabase,
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getAllStories(page, state.config.pageSize, token).listStory
            ...
            database.withTransaction {
                if (loadType == LoadType.REFRESH) {
                    ...
                    database.storyResponseDao().deleteAll()
                }
                ...
                database.storyResponseDao().insertStoryResponses(responseData)
            }
